...
<div class="ConteudoInicial">
        <div class="telainicial">
            <div class="parte1">
                <div class="titulo">
                    <h1 style="color:black">Novidades</h1>
                </div>
                <div class="carrossel">
                    <!-- <div class="conteudo"> -->
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <a href="">
                                    <img src="../../css/img/fundos/novidades.png" alt="">
                                </a>
                              </div>
            ...
            <div class="parte2">
                <div>
                    ...
                    <div class="convidados">
                        ...
                        <center>
                            <a href="" class="red-btn">Ver Mais</a>
                        </center>
                    </div>
                </div>
            </div>
